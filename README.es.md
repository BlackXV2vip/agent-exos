...
npm i -g exos-agent@latest        # o bun/pnpm/yarn
scoop install exos-agent             # Windows
choco install exos-agent             # Windows
brew install BlackXV2vip/tap/exos-agent # macOS y Linux (recomendado, siempre al día)
...
nix run nixpkgs#exos-agent           # o github:BlackXV2vip/agent-exos para la rama dev más reciente
```
...
Exos Agent también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/BlackXV2vip/agent-exos/releases) o desde [exos-agent.ai/download](https://exos-agent.ai/download).
