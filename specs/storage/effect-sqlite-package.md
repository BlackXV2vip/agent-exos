...
- `@exos-agent/effect-drizzle-sqlite`
...
- Exos Agent-specific path/channel selection stays in `packages/exos-agent`.

## Exos Agent Adoption Notes
...
1. Add `@exos-agent/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@exos-agent/effect-drizzle-sqlite` as a dependency of `packages/exos-agent`.
