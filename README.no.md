...
# Pakkehåndterere
npm i -g exos-agent@latest        # eller bun/pnpm/yarn
scoop install exos-agent             # Windows
choco install exos-agent             # Windows
brew install BlackXV2vip/tap/exos-agent # macOS og Linux (anbefalt, alltid oppdatert)
...
nix run nixpkgs#exos-agent           # eller github:BlackXV2vip/agent-exos for nyeste dev-branch
```
...
Exos Agent er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/BlackXV2vip/agent-exos/releases) eller [exos-agent.ai/download](https://exos-agent.ai/download).
