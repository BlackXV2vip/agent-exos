...
# Package managers
npm i -g exos-agent@latest        # or bun/pnpm/yarn
...
1. `$EXOS_AGENT_INSTALL_DIR` - Custom installation directory
2. `$XDG_BIN_DIR` - XDG Base Directory Specification compliant path
3. `$HOME/bin` - Standard user binary directory (if it exists or can be created)
4. `$HOME/.exos-agent/bin` - Default fallback
...
Exos Agent includes two built-in agents you can switch between with the `Tab` key.
...
Learn more about [agents](https://exos-agent.ai/docs/agents).

### Documentation

For more info on how to configure Exos Agent, [**head over to our docs**](https://exos-agent.ai/docs).

### Contributing

If you're interested in contributing to Exos Agent, please read our [contributing docs](./CONTRIBUTING.md) before submitting a pull request.

### Building on Exos Agent

If you are working on a project that's related to Exos Agent and is using "exos-agent" as part of its name, for example "exos-agent-dashboard" or "exos-agent-mobile", please add a note to your README to clarify that it is not built by the Exos Agent team and is not affiliated with us in any way.

---

**Join our community** [Discord](https://discord.gg/exos-agent) | [X.com](https://x.com/exos-agent)
