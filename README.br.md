...
brew install BlackXV2vip/tap/exos-agent # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#exos-agent           # ou github:BlackXV2vip/agent-exos para a branch dev mais recente
```
...
O Exos Agent também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/BlackXV2vip/agent-exos/releases) ou em [exos-agent.ai/download](https://exos-agent.ai/download).
