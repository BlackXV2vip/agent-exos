...
Desktop application and browser-based app issues, including `exos-agent web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core exos-agent server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Exos Agent Zen, Exos Agent Go, and billing issues.
