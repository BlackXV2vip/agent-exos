...
- PR #13942: https://github.com/BlackXV2vip/agent-exos/pull/13942

## Do Not Translate (Locale Additions)

- `ExosAgent` (preserve casing in prose; keep `exos-agent` only when it is part of commands, package names, paths, or code)
- `ExosAgent Zen`
- `ExosAgent CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `exos-agent` in prose when referring to the product name; use `ExosAgent`
