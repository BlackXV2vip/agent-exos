...
- PR #15835: https://github.com/BlackXV2vip/agent-exos/pull/15835

## Do Not Translate (Locale Additions)

- `ExosAgent` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `exos-agent` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `ExosAgent` in prose, `exos-agent` only for exact technical identifiers
...
- Avoid changing `exos-agent` to `ExosAgent` inside commands, URLs, package names, or code literals
