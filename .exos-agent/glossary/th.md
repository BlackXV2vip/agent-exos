...
- PR #10809: https://github.com/BlackXV2vip/agent-exos/pull/10809
- PR #11496: https://github.com/BlackXV2vip/agent-exos/pull/11496

## Do Not Translate (Locale Additions)

- `ExosAgent` (preserve casing in prose; keep `exos-agent` only in commands, package names, paths, or code)
- `ExosAgent CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
