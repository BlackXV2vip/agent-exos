...
import { tool } from "@exos-agent/plugin"
...
This tool searches PRs in the BlackXV2vip/agent-exos repository and returns LLM-friendly results including:
- PR number and title
- Author
...
Use the query parameter to search for keywords that might appear in PR titles or descriptions.`,
  ...
  async execute(args) {
    const owner = "BlackXV2vip"
    const repo = "exos-agent"
