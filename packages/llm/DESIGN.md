...
> current private `@exos-agent/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@exos-agent/ai`
...
import { LLM } from "@exos-agent/ai"
import { OpenAI } from "@exos-agent/ai/providers/openai"
...
```ts
import { Message } from "@exos-agent/ai"
...
import { LLM, Tool } from "@exos-agent/ai"
...
```ts
import { LLM } from "@exos-agent/ai/promise"
import { OpenAI } from "@exos-agent/ai/providers/openai"
...
```ts
import { LLMSchema } from "@exos-agent/ai/schema"
...
```ts
import { Provider, Protocol } from "@exos-agent/ai/provider"
...
@exos-agent/ai/promise
  Promise/AsyncIterable LLM facade

@exos-agent/ai/schema
  serializable domain schemas

@exos-agent/ai/provider
  experimental Provider and Protocol authoring APIs

@exos-agent/ai/providers/openai
@exos-agent/ai/providers/anthropic
@exos-agent/ai/providers/google
...
```
