...
const releaseId = process.env.EXOS_AGENT_RELEASE
if (!releaseId) throw new Error("EXOS_AGENT_RELEASE is required")

const version = process.env.EXOS_AGENT_VERSION
if (!version) throw new Error("EXOS_AGENT_VERSION is required")
...
const macxTarGz = "exos-agent-desktop-mac-x64.app.tar.gz"
const macaTarGz = "exos-agent-desktop-mac-arm64.app.tar.gz"
