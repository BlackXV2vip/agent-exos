export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von ExosAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von ExosAgent wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'exos-agent' zu verwenden.",
