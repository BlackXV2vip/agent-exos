export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من ExosAgent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من ExosAgent، هل ترغب في تثبيته وإعادة تشغيله؟",
