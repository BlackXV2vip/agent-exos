export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju ExosAgent-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} ExosAgent-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'exos-agent'.",
