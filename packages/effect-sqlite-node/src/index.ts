...
export const TypeId: TypeId = "~@exos-agent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@exos-agent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@exos-agent/effect-sqlite-node/NodeSqliteClient")
