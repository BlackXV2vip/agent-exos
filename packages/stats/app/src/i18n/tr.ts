export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | ExosAgent Data",
  "app.description":
    "ExosAgent Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde ExosAgent Data logosu",
  ...
  "header.githubAria": "GitHub'da ExosAgent'a yıldız ver",
  "header.github": "GitHub",
  "header.tryExosAgent": "ExosAgent'u dene",
  ...
  "footer.homeAria": "ExosAgent ana sayfası",
  ...
  "home.topModelsDescription": "ExosAgent Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz ExosAgent Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | ExosAgent Data",
  "lab.description":
    "ExosAgent Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son ExosAgent kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "ExosAgent'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son ExosAgent kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük ExosAgent token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | ExosAgent Data",
  "model.description":
    "{{model}} için ExosAgent Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda ExosAgent Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki ExosAgent Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki ExosAgent Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde ExosAgent Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son ExosAgent Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz ExosAgent Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük ExosAgent Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz ExosAgent Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama ExosAgent Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan ExosAgent Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen ExosAgent Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son ExosAgent Go token hacmine göre yakındaki modeller.",
