export const dict = {
  "app.title": "Ranking de uso de modelos de IA | ExosAgent Data",
  "app.description":
    "Explore o uso do ExosAgent Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do ExosAgent Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao ExosAgent no GitHub",
  "header.github": "GitHub",
  "header.tryExosAgent": "Experimente o ExosAgent",
  ...
  "footer.homeAria": "Início do ExosAgent",
  ...
  "modal.title": "Newsletter do ExosAgent",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no ExosAgent Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do ExosAgent Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | ExosAgent Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no ExosAgent Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do ExosAgent.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no ExosAgent",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do ExosAgent",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do ExosAgent nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | ExosAgent Data",
  "model.description":
    "Veja dados de uso de {{model}} no ExosAgent Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no ExosAgent Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do ExosAgent Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do ExosAgent Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do ExosAgent Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do ExosAgent Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do ExosAgent Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do ExosAgent Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do ExosAgent Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do ExosAgent Go.",
  ...
  "model.geoDescription": "Tokens do modelo ExosAgent Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do ExosAgent Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do ExosAgent Go.",
