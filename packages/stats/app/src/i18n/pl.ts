export const dict = {
  "app.title": "Rankingi użycia modeli AI | ExosAgent Data",
  "app.description":
    "Przeglądaj użycie ExosAgent Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny ExosAgent Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę ExosAgent na GitHub",
  "header.github": "GitHub",
  "header.tryExosAgent": "Wypróbuj ExosAgent",
  ...
  "footer.homeAria": "Strona główna ExosAgent",
  ...
  "home.topModelsDescription": "Użycie modeli w ExosAgent Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy ExosAgent Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | ExosAgent Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w ExosAgent Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia ExosAgent.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w ExosAgent",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia ExosAgent",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów ExosAgent z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | ExosAgent Data",
  "model.description":
    "Zobacz dane użycia {{model}} w ExosAgent Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie ExosAgent Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu ExosAgent Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu ExosAgent Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia ExosAgent Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny ExosAgent Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia ExosAgent Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów ExosAgent Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy ExosAgent Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji ExosAgent Go.",
  ...
  "model.geoDescription": "Tokeny modelu ExosAgent Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne ExosAgent Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów ExosAgent Go.",
