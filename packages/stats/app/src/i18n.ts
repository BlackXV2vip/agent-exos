...
const en = {
  "app.title": "AI Model Usage Rankings | ExosAgent Data",
  "app.description":
    "Explore ExosAgent Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "ExosAgent Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star ExosAgent on GitHub",
  "header.github": "GitHub",
  "header.tryExosAgent": "Try ExosAgent",
  ...
  "footer.homeAria": "ExosAgent home",
  ...
  "home.topModelsDescription": "Usage of models across ExosAgent Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique ExosAgent Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | ExosAgent Data",
  "lab.description":
    "Compare {{lab}} models used in ExosAgent Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent ExosAgent usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in ExosAgent",
  ...
  "lab.shareOfUsage": "{{share}} of recent ExosAgent usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | ExosAgent Data",
  "model.description":
    "View {{model}} ExosAgent Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. ExosAgent Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's ExosAgent Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's ExosAgent Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No ExosAgent Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no ExosAgent Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "ExosAgent Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No ExosAgent Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent ExosAgent Go token volume.",
