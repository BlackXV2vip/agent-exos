import exosAgentWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/BlackXV2vip/agent-exos",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "exos-agent:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://exos-agent.ai/">
            <strong>{i18n.t("header.tryExosAgent")}</strong>
          </a>
          <button
...
function ExosAgentMark() {
  return (
    <svg data-slot="exos-agent-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://exos-agent.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://exos-agent.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@exos-agent.ai", label: i18n.t("footer.contact") },
    { href: "https://exos-agent.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/exos-agent", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://exos-agent.ai" aria-label={i18n.t("footer.homeAria")}>
          <ExosAgentMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={exosAgentWordmarkDark} alt="ExosAgent" />
          <button
