...
import { isSessionNotFoundError, isUnauthorizedError, ExosAgent } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = ExosAgent.make({ baseUrl: "http://localhost:3000" })
