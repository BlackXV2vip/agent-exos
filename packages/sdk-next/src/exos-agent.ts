import { ExosAgent } from "@exos-agent/client/effect"
...
import { createEmbeddedRoutes } from "@exos-agent/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("ExosAgent.create")(function* () {
  ...
  const client = yield* ExosAgent.make({ baseUrl: "http://exos-agent.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/sdk-next/ExosAgent") {}
