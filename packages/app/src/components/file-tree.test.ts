...
beforeAll(async () => {
  ...
  mock.module("@exos-agent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@exos-agent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@exos-agent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@exos-agent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
