import { useFilteredList } from "@exos-agent/ui/hooks"
import { useSpring } from "@exos-agent/ui/motion-spring"
import {
  createEffect,
  on,
  Component,
...
import { DockShellForm, DockTray } from "@exos-agent/ui/dock-surface"
import { Icon } from "@exos-agent/ui/icon"
import { ProviderIcon } from "@exos-agent/ui/provider-icon"
import { Tooltip, TooltipKeybind } from "@exos-agent/ui/tooltip"
...
import { KeybindV2 } from "@exos-agent/ui/v2/keybind-v2"
...
import type { ReferenceInfo } from "@exos-agent/sdk/v2/client"
