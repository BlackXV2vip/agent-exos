export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ExosAgentが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、ExosAgentで{{provider}}モデルを使用します。",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してExosAgentで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、ExosAgentで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するExosAgentサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingExosAgent": "ExosAgentを確認中...",
  "wsl.onboarding.checkingExosAgentIn": "{{distro}}内のExosAgentを確認中...",
  "wsl.onboarding.updatingExosAgent": "ExosAgentを更新中...",
  "wsl.onboarding.updatingExosAgentIn": "{{distro}}内のExosAgentを更新中...",
  "wsl.onboarding.updateExosAgentIn": "{{distro}}内のExosAgentを更新してください。",
  "wsl.onboarding.updateExosAgent": "ExosAgentを更新",
  "wsl.onboarding.exosAgentReadyIn": "{{distro}}内のExosAgentの準備ができました。",
  "wsl.onboarding.exosAgentReady": "ExosAgentの準備ができました。",
  "wsl.onboarding.installExosAgentIn": "{{distro}}にExosAgentをインストールしてください。",
  "wsl.onboarding.installExosAgent": "ExosAgentをインストール",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgentがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ExosAgentでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、ExosAgentをもう一度開いてください。",
  ...
  "toast.update.description": "ExosAgentの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをExosAgentチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ExosAgentはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "ExosAgentには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でExosAgentサーバーを実行します。",
  ...
  "settings.general.row.language.description": "ExosAgentの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのExosAgentの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "ExosAgentがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "ExosAgentのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "ExosAgent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "ExosAgent は最新バージョンです。",
