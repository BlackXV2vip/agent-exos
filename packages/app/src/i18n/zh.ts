...
export const dict = {
  ...
  "dialog.provider.exos-agent.note": "使用 ExosAgent Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "ExosAgent 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.exosAgentZen.line1": "ExosAgent Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 ExosAgent 服务器。",
  ...
  "wsl.onboarding.checkingExosAgent": "正在检查 ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "正在检查 {{distro}} 中的 ExosAgent...",
  "wsl.onboarding.updatingExosAgent": "正在更新 ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "正在更新 {{distro}} 中的 ExosAgent...",
  "wsl.onboarding.updateExosAgentIn": "更新 {{distro}} 中的 ExosAgent。",
  "wsl.onboarding.updateExosAgent": "更新 ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "{{distro}} 中的 ExosAgent 已就绪。",
  "wsl.onboarding.exosAgentReady": "ExosAgent 已就绪。",
  "wsl.onboarding.installExosAgentIn": "在 {{distro}} 中安装 ExosAgent。",
  "wsl.onboarding.installExosAgent": "安装 ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "未安装 ExosAgent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "ExosAgent 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 ExosAgent。",
  ...
  "toast.update.description": "ExosAgent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 ExosAgent 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: ExosAgent 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 ExosAgent 服务器。",
  ...
  "settings.general.row.language.description": "更改 ExosAgent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 ExosAgent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 ExosAgent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 ExosAgent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 ExosAgent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 ExosAgent。",
