...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ExosAgent 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.exosAgentZen.line1": "ExosAgent Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 ExosAgent 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 ExosAgent 伺服器。",
  ...
  "wsl.onboarding.checkingExosAgent": "正在檢查 ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "正在檢查 {{distro}} 中的 ExosAgent...",
  ...
  "wsl.onboarding.exosAgentReadyIn": "{{distro}} 中的 ExosAgent 已就緒。",
  "wsl.onboarding.exosAgentReady": "ExosAgent 已就緒。",
  "wsl.onboarding.installExosAgentIn": "在 {{distro}} 中安裝 ExosAgent。",
  "wsl.onboarding.installExosAgent": "安裝 ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "未安裝 ExosAgent",
  ...
  "wsl.onboarding.wslUnavailable.description": "ExosAgent 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 ExosAgent。",
  ...
  "toast.update.description": "ExosAgent 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 ExosAgent 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: ExosAgent 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 ExosAgent 伺服器。",
  ...
  "settings.general.row.language.description": "變更 ExosAgent 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 ExosAgent 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 ExosAgent 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 ExosAgent 的主題。",
  ...
  "settings.updates.row.startup.description": "在 ExosAgent 啟動時自動檢查更新",
