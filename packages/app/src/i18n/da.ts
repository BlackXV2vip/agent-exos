export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ExosAgent.",
  ...
  "dialog.server.description": "Skift hvilken ExosAgent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingExosAgent": "Tjekker ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Tjekker ExosAgent i {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Opdaterer ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Opdaterer ExosAgent i {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Opdater ExosAgent i {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Opdater ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før ExosAgent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter ExosAgent igen.",
  ...
  "toast.update.description": "En ny version af ExosAgent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ExosAgent-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ExosAgent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ExosAgent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ExosAgent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan ExosAgent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om ExosAgent følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ExosAgent er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ExosAgent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ExosAgent.",
