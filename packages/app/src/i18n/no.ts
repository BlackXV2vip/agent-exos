...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ExosAgent.",
  ...
  "dialog.server.description": "Bytt hvilken ExosAgent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ExosAgent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ExosAgent-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ExosAgent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ExosAgent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ExosAgent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ExosAgent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ExosAgent skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ExosAgent er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ExosAgent starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ExosAgent.",
  ...
  "wsl.onboarding.checkingExosAgent": "Sjekker ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Sjekker ExosAgent i {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Oppdaterer ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Oppdaterer ExosAgent i {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Oppdater ExosAgent i {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Oppdater ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent er klar i {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent er klar.",
  "wsl.onboarding.installExosAgentIn": "Installer ExosAgent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før ExosAgent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter ExosAgent på nytt.",
