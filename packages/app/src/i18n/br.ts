export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ExosAgent.",
  ...
  "dialog.server.description": "Trocar para qual servidor ExosAgent este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingExosAgent": "Verificando o ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Verificando o ExosAgent em {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Atualizando o ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Atualizando o ExosAgent em {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Atualize o ExosAgent em {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Atualizar o ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "O ExosAgent está pronto em {{distro}}.",
  "wsl.onboarding.exosAgentReady": "O ExosAgent está pronto.",
  "wsl.onboarding.installExosAgentIn": "Instale o ExosAgent em {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instalar o ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o ExosAgent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O ExosAgent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o ExosAgent novamente.",
  ...
  "toast.update.description": "Uma nova versão do ExosAgent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ExosAgent",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ExosAgent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ExosAgent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ExosAgent",
  ...
  "settings.general.row.appearance.description": "Personalize como o ExosAgent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ExosAgent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ExosAgent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ExosAgent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ExosAgent.",
