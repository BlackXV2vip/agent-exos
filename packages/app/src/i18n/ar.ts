export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "يمنحك ExosAgent Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في ExosAgent.",
  ...
  "dialog.server.description": "تبديل خادم ExosAgent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingExosAgent": "جارٍ التحقق من ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "جارٍ التحقق من ExosAgent في {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "جارٍ تحديث ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "جارٍ تحديث ExosAgent في {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "حدّث ExosAgent في {{distro}}.",
  "wsl.onboarding.updateExosAgent": "تحديث ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent جاهز في {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent جاهز.",
  "wsl.onboarding.installExosAgentIn": "ثبّت ExosAgent في {{distro}}.",
  "wsl.onboarding.installExosAgent": "تثبيت ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن ExosAgent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على ExosAgent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح ExosAgent.",
  ...
  "toast.update.description": "نسخة جديدة من ExosAgent ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق ExosAgent",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن ExosAgent لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن ExosAgent نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم ExosAgent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ ExosAgent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور ExosAgent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان ExosAgent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة ExosAgent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل ExosAgent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من ExosAgent.",
