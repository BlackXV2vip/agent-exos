export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у ExosAgent.",
  ...
  "dialog.server.description": "Перемкніть сервер ExosAgent, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingExosAgent": "Перевірка ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Перевірка ExosAgent у {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Оновлення ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Оновлення ExosAgent у {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Оновіть ExosAgent у {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Оновити ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent готовий до роботи у {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent готовий до роботи.",
  "wsl.onboarding.installExosAgentIn": "Встановіть ExosAgent у {{distro}}.",
  "wsl.onboarding.installExosAgent": "Встановити ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в ExosAgent потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте ExosAgent.",
  ...
  "toast.update.description": "Нова версія ExosAgent ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді ExosAgent",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, ExosAgent ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер ExosAgent всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу ExosAgent",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд ExosAgent на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи ExosAgent використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему ExosAgent.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску ExosAgent",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію ExosAgent.",
