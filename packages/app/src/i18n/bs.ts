export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ExosAgent-u.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ExosAgent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ExosAgent-u.",
  ...
  "dialog.server.description": "Promijeni na koji se ExosAgent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingExosAgent": "Provjera ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Provjera ExosAgent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Ažuriranje ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Ažuriranje ExosAgent u distribuciji {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Ažuriraj ExosAgent u distribuciji {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Ažuriraj ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent je spreman.",
  "wsl.onboarding.installExosAgentIn": "Instaliraj ExosAgent u distribuciji {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instaliraj ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi ExosAgent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori ExosAgent.",
  ...
  "toast.update.description": "Nova verzija ExosAgent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ExosAgent timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ExosAgent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ExosAgent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ExosAgent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako ExosAgent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ExosAgent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ExosAgent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ExosAgent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ExosAgent-a.",
