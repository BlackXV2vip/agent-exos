export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ExosAgent.",
  ...
  "dialog.server.description": "Changez le serveur ExosAgent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingExosAgent": "Vérification d'ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Vérification d'ExosAgent dans {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Mise à jour d'ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Mise à jour d'ExosAgent dans {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Mettez à jour ExosAgent dans {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Mettre à jour ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent est prêt dans {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent est prêt.",
  "wsl.onboarding.installExosAgentIn": "Installez ExosAgent dans {{distro}}.",
  "wsl.onboarding.installExosAgent": "Installer ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'ExosAgent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez ExosAgent.",
  ...
  "toast.update.description":
    "Une nouvelle version d'ExosAgent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ExosAgent",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ExosAgent ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "ExosAgent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur ExosAgent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ExosAgent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'ExosAgent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si ExosAgent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ExosAgent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ExosAgent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ExosAgent.",
