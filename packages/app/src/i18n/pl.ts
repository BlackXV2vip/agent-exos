export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ExosAgent.",
  ...
  "dialog.server.description": "Przełącz serwer ExosAgent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingExosAgent": "Sprawdzanie ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Sprawdzanie ExosAgent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Aktualizowanie ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Aktualizowanie ExosAgent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Zaktualizuj ExosAgent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Zaktualizuj ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent jest gotowy.",
  "wsl.onboarding.installExosAgentIn": "Zainstaluj ExosAgent w dystrybucji {{distro}}.",
  "wsl.onboarding.installExosAgent": "Zainstaluj ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim ExosAgent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz ExosAgent.",
  ...
  "toast.update.description": "Nowa wersja ExosAgent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ExosAgent",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: ExosAgent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "ExosAgent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer ExosAgent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ExosAgent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd ExosAgent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ExosAgent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ExosAgent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ExosAgent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ExosAgent.",
