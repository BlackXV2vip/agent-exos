export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ExosAgent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ExosAgent.",
  ...
  "dialog.server.description": "Switch which ExosAgent server this app connects to.",
  ...
  "wsl.onboarding.checkingExosAgent": "Checking ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Checking ExosAgent in {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Updating ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Updating ExosAgent in {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Update ExosAgent in {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Update ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent is ready in {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent is ready.",
  "wsl.onboarding.installExosAgentIn": "Install ExosAgent in {{distro}}.",
  "wsl.onboarding.installExosAgent": "Install ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before ExosAgent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ExosAgent.",
  ...
  "toast.update.description": "A new version of ExosAgent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ExosAgent team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ExosAgent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the ExosAgent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ExosAgent",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how ExosAgent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ExosAgent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ExosAgent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ExosAgent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ExosAgent.",
