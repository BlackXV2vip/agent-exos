...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ExosAgent zu nutzen.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ExosAgent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ExosAgent zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den ExosAgent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.exos-agent": "ExosAgent",
  ...
  "wsl.onboarding.checkingExosAgent": "ExosAgent wird geprüft...",
  "wsl.onboarding.checkingExosAgentIn": "ExosAgent in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingExosAgent": "ExosAgent wird aktualisiert...",
  "wsl.onboarding.updatingExosAgentIn": "ExosAgent in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateExosAgentIn": "Aktualisieren Sie ExosAgent in {{distro}}.",
  "wsl.onboarding.updateExosAgent": "ExosAgent aktualisieren",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent ist in {{distro}} bereit.",
  "wsl.onboarding.exosAgentReady": "ExosAgent ist bereit.",
  "wsl.onboarding.installExosAgentIn": "Installieren Sie ExosAgent in {{distro}}.",
  "wsl.onboarding.installExosAgent": "ExosAgent installieren",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor ExosAgent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann ExosAgent erneut.",
  ...
  "toast.update.description": "Eine neue Version von ExosAgent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ExosAgent-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ExosAgent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "ExosAgent Desktop",
  ...
  "settings.desktop.wsl.description": "ExosAgent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ExosAgent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie ExosAgent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob ExosAgent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ExosAgent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ExosAgent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ExosAgent.",
