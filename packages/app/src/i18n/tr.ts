...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ExosAgent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ExosAgent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak ExosAgent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ExosAgent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ExosAgent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingExosAgent": "ExosAgent kontrol ediliyor...",
  "wsl.onboarding.checkingExosAgentIn": "{{distro}} içinde ExosAgent kontrol ediliyor...",
  "wsl.onboarding.updatingExosAgent": "ExosAgent güncelleniyor...",
  "wsl.onboarding.updatingExosAgentIn": "{{distro}} içinde ExosAgent güncelleniyor...",
  "wsl.onboarding.updateExosAgentIn": "{{distro}} içindeki ExosAgent'u güncelleyin.",
  "wsl.onboarding.updateExosAgent": "ExosAgent'u güncelle",
  "wsl.onboarding.exosAgentReadyIn": "{{distro}} içinde ExosAgent hazır.",
  "wsl.onboarding.exosAgentReady": "ExosAgent hazır.",
  "wsl.onboarding.installExosAgentIn": "ExosAgent'u {{distro}} içine kurun.",
  "wsl.onboarding.installExosAgent": "ExosAgent'u kur",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ExosAgent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından ExosAgent'u tekrar açın.",
  ...
  "toast.update.description": "ExosAgent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ExosAgent ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ExosAgent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ExosAgent Masaüstü",
  ...
  "settings.desktop.wsl.description": "ExosAgent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ExosAgent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "ExosAgent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ExosAgent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ExosAgent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ExosAgent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ExosAgent'un en son sürümünü kullanıyorsunuz.",
