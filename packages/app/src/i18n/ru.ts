export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в ExosAgent.",
  ...
  "dialog.server.description": "Переключите сервер ExosAgent к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingExosAgent": "Проверка ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Проверка ExosAgent в {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Обновление ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Обновление ExosAgent в {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Обновите ExosAgent в {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Обновить ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent в {{distro}} готов к работе.",
  "wsl.onboarding.exosAgentReady": "ExosAgent готов к работе.",
  "wsl.onboarding.installExosAgentIn": "Установите ExosAgent в {{distro}}.",
  "wsl.onboarding.installExosAgent": "Установить ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в ExosAgent требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте ExosAgent.",
  ...
  "toast.update.description": "Новая версия ExosAgent ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде ExosAgent",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что ExosAgent пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер ExosAgent внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения ExosAgent",
  ...
  "settings.general.row.appearance.description": "Настройте как ExosAgent выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли ExosAgent системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление ExosAgent.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске ExosAgent",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию ExosAgent.",
