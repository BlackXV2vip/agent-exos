export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ExosAgent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ExosAgent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "ExosAgent Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ExosAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ExosAgent.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ExosAgent se conecta esta app.",
  ...
  "wsl.onboarding.checkingExosAgent": "Comprobando ExosAgent...",
  "wsl.onboarding.checkingExosAgentIn": "Comprobando ExosAgent en {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Actualizando ExosAgent...",
  "wsl.onboarding.updatingExosAgentIn": "Actualizando ExosAgent en {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Actualiza ExosAgent en {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Actualizar ExosAgent",
  "wsl.onboarding.exosAgentReadyIn": "ExosAgent está listo en {{distro}}.",
  "wsl.onboarding.exosAgentReady": "ExosAgent está listo.",
  "wsl.onboarding.installExosAgentIn": "Instala ExosAgent en {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instalar ExosAgent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "ExosAgent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que ExosAgent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "ExosAgent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir ExosAgent.",
  ...
  "toast.update.description": "Una nueva versión de ExosAgent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ExosAgent",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ExosAgent no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "ExosAgent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ExosAgent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ExosAgent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve ExosAgent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ExosAgent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ExosAgent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ExosAgent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ExosAgent.",
