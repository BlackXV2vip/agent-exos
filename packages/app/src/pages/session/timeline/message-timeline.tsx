...
import { Accordion } from "@exos-agent/ui/accordion"
import { Button } from "@exos-agent/ui/button"
import { Card } from "@exos-agent/ui/card"
import {
  ContextToolGroup,
  Message,
  MessageDivider,
  ...
  partDefaultOpen,
  type UserActions,
} from "@exos-agent/session-ui/message-part"
import { DiffChanges } from "@exos-agent/ui/diff-changes"
import { FileIcon } from "@exos-agent/ui/file-icon"
import { Icon } from "@exos-agent/ui/icon"
import { IconButton } from "@exos-agent/ui/icon-button"
import { Icon as IconV2 } from "@exos-agent/ui/v2/icon"
import { IconButtonV2 } from "@exos-agent/ui/v2/icon-button-v2"
import { DropdownMenu } from "@exos-agent/ui/dropdown-menu"
import { MenuV2 } from "@exos-agent/ui/v2/menu-v2"
import { Dialog } from "@exos-agent/ui/dialog"
import { DialogFooter, DialogHeader, DialogTitleGroup, DialogV2 } from "@exos-agent/ui/v2/dialog-v2"
import { InlineInput } from "@exos-agent/ui/inline-input"
import { ButtonV2 } from "@exos-agent/ui/v2/button-v2"
import { SessionRetry } from "@exos-agent/session-ui/session-retry"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner, ScrollView } from "@exos-agent/ui/scroll-view"
import { StickyAccordionHeader } from "@exos-agent/ui/sticky-accordion-header"
import { TextField } from "@exos-agent/ui/text-field"
import { TextReveal } from "@exos-agent/ui/text-reveal"
import { TextShimmer } from "@exos-agent/ui/text-shimmer"
import type {
  AssistantMessage,
  ...
  ToolPart,
  UserMessage,
} from "@exos-agent/sdk/v2"
import { showToast } from "@/utils/toast"
import { getDirectory, getFilename } from "@exos-agent/core/util/path"
import { Popover as KobaltePopover } from "@kobalte/core/popover"
import { normalize } from "@exos-agent/session-ui/session-diff"
import { useFileComponent } from "@exos-agent/ui/context/file"
import { shouldMarkBoundaryGesture, normalizeWheelDelta } from "@/pages/session/message-gesture"
import { SessionContextUsage } from "@/components/session-context-usage"
import { useDialog } from "@exos-agent/ui/context/dialog"
