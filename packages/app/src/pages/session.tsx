import type { FilePart, Project, UserMessage, VcsFileDiff } from "@exos-agent/sdk/v2"
import { getFilename } from "@exos-agent/core/util/path"
...
import type { SessionReviewLineComment } from "@exos-agent/session-ui/session-review"
import { ResizeHandle } from "@exos-agent/ui/resize-handle"
import { Select } from "@exos-agent/ui/select"
import { SelectV2 } from "@exos-agent/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@exos-agent/ui/scroll-view"
import { Tabs } from "@exos-agent/ui/tabs"
import { ButtonV2 } from "@exos-agent/ui/v2/button-v2"
import { createAutoScroll } from "@exos-agent/ui/hooks"
import { previewSelectedLines } from "@exos-agent/session-ui/pierre/selection-bridge"
import { Button } from "@exos-agent/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@exos-agent/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@exos-agent/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@exos-agent/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@exos-agent/session-ui/v2/session-review-v2"
