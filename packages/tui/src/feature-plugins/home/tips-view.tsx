import type { TuiPluginApi } from "@exos-agent/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent ExosAgent from reading sensitive files",
  ...
  "Run {highlight}exos-agent serve{/highlight} for headless API access to ExosAgent",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/BlackXV2vip/agent-exos{/highlight} in a container",
  "Use {highlight}/connect{/highlight} with ExosAgent Zen for curated, tested models",
