...
import defaultSoundPath from "@exos-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@exos-agent/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@exos-agent/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@exos-agent/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@exos-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@exos-agent/ui/audio/yup-01.mp3" with { type: "file" }
