import type { Hooks, PluginInput } from "@exos-agent/plugin"
import type { Model } from "@exos-agent/sdk/v2"
import { InstallationVersion } from "@exos-agent/core/installation/version"
import { OauthCallbackPage } from "@exos-agent/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. ExosAgent will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
