...
import {
  ...
  type TuiSlotPlugin,
  type TuiTheme,
} from "@exos-agent/plugin/tui"
import path from "path"
import { fileURLToPath } from "url"
import { TuiConfig } from "@/config/tui"
import { AppNodeBuilder } from "@exos-agent/core/effect/app-node-builder"
import { errorData, errorMessage } from "@exos-agent/tui/util/error"
import { isRecord } from "@exos-agent/tui/util/record"
...
import { hasTheme, upsertTheme } from "@exos-agent/tui/context/theme"
import { Global } from "@exos-agent/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@exos-agent/core/util/flock"
import { Flag } from "@exos-agent/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@exos-agent/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@exos-agent/core/v1/config/plugin"
import { createCommandShim } from "@exos-agent/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@exos-agent/tui/plugin/runtime"
