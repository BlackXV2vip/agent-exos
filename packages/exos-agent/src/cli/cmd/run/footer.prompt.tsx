...
import { normalizePromptContent } from "@exos-agent/tui/editor"
...
import { EXOS_AGENT_BASE_MODE, useBindings } from "@exos-agent/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close ExosAgent" } satisfies SlashOption,
    ]
