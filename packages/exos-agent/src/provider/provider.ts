...
import { Hash } from "@exos-agent/core/util/hash"
...
import { optional } from "@exos-agent/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@exos-agent/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://exos-agent.ai/",
            "X-Title": "exos-agent",
            "X-BILLING-INVOKE-ORIGIN": "ExosAgent",
          },
        },
      }),
    vercel: () =>
