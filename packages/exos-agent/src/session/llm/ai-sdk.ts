import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@exos-agent/llm"
...
// Move this extraction into @exos-agent/llm when Copilot is handled by the native runtime.
