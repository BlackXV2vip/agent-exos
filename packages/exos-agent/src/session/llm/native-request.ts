import type { JsonSchema, LLMRequest, ProviderMetadata } from "@exos-agent/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@exos-agent/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @exos-agent/llm request objects from exos-agent's session/AI SDK-shaped data.
  return LLM.request({
