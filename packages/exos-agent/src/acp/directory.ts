...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@exos-agent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@exos-agent/ACPDirectory") {}
