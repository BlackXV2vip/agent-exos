...
import type { AssistantMessage as ExosAgentAssistantMessage, Message } from "@exos-agent/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@exos-agent/core/effect/app-node"
...
export type AssistantTokenCost = Pick<ExosAgentAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ExosAgentAssistantMessage, "role"> &
  Partial<Pick<ExosAgentAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@exos-agent/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@exos-agent/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@exos-agent/ACPUsage") {}
