...
import type { NamedError } from "@exos-agent/core/util/error"
  ...
  test("maps free limits to Go upsell action", () => {
    ...
    expect(SessionRetry.retryable(error, "exos-agent")).toEqual({
      ...
      action: {
        ...
        message: "Subscribe to ExosAgent Go for reliable access to the best open-source models, starting at $5/month.",
        label: "subscribe",
