...
export const dict = {
  ...
  "notFound.title": "No encontrado | exos-agent",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "exos-agent logo claro",
  "notFound.logoDarkAlt": "exos-agent logo oscuro",
  ...
  "app.meta.description": "ExosAgent - El agente de codificación de código abierto.",

  "home.title": "ExosAgent | El agente de codificación IA de código abierto",

  "temp.title": "exos-agent | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "exos-agent zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por exos-agent",
  ...
  "temp.screenshot.caption": "exos-agent TUI con el tema tokyonight",
  "temp.screenshot.alt": "exos-agent TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de exos-agent claro",
  "temp.logoDarkAlt": "logo de exos-agent oscuro",
  ...
  "home.what.title": "¿Qué es ExosAgent?",
  "home.what.body":
    "ExosAgent es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, ExosAgent es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "ExosAgent no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es ExosAgent?",
  "home.faq.a1":
    "ExosAgent es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso ExosAgent?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar ExosAgent?",
  "home.faq.a3.p1":
    "No necesariamente, ExosAgent viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, ExosAgent también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con ExosAgent?",
  "home.faq.a4.p1":
    "Sí, ExosAgent soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar ExosAgent en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! ExosAgent ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta ExosAgent?",
  "home.faq.a6":
    "ExosAgent es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es ExosAgent de código abierto?",
  "home.faq.a8.p1": "Sí, ExosAgent es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que ExosAgent ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "ExosAgent Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que ExosAgent ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es ExosAgent Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de ExosAgent.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá ExosAgent negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, ExosAgent añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con ExosAgent, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de ExosAgent.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con ExosAgent, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "ExosAgent Go | Modelos de programación de bajo coste para todos",
  ...
  "go.testimonials.handle": "@ExosAgent",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de ExosAgent a tantas personas como sea posible. ExosAgent Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con ExosAgent o cualquier agente.",
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a ExosAgent Go - {{link}}",

  "black.meta.title": "ExosAgent Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de ExosAgent Black.",
  ...
  "black.title": "ExosAgent Black | Precios",
  ...
  "black.workspace.title": "ExosAgent Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a ExosAgent Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de ExosAgent Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "ExosAgent Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con exos-agent cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona exos-agent",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia exos-agent y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de exos-agent.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de exos-agent Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a ExosAgent Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan ExosAgent Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan ExosAgent Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a ExosAgent Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "ExosAgent Go" como proveedor en tu configuración de exos-agent para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a ExosAgent Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a ExosAgent Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "ExosAgent Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "ExosAgent | Descargar",
  "download.meta.description": "Descarga ExosAgent para macOS, Windows y Linux",
  "download.hero.title": "Descargar ExosAgent Desktop",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "ExosAgent Terminal",
  "download.section.desktop": "ExosAgent Desktop",
  "download.section.extensions": "Extensiones ExosAgent",
  "download.section.integrations": "Integraciones ExosAgent",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar ExosAgent a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", ExosAgent funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "ExosAgent es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque ExosAgent funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en ExosAgent.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "ExosAgent | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a ExosAgent para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "ExosAgent opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es ExosAgent Enterprise?",
  "enterprise.faq.a1":
    "ExosAgent Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con ExosAgent Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. ExosAgent por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con ExosAgent Enterprise?",
  "enterprise.faq.a4":
    "Sí. ExosAgent no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "ExosAgent | Marca",
  "brand.meta.description": "Guías de marca de ExosAgent",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca ExosAgent.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "ExosAgent | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de ExosAgent",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para ExosAgent",
