      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://exos-agent.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>exos-agent.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g exos-agent")}>
                <code>
                  npm i -g <strong>exos-agent</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g exos-agent")}>
                <code>
                  bun add -g <strong>exos-agent</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/exos-agent")}>
                <code>
                  brew install <strong>anomalyco/tap/exos-agent</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S exos-agent")}>
                <code>
                  paru -S <strong>exos-agent</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask exos-agent-desktop")}>
                <code>
                  brew install --cask <strong>exos-agent-desktop</strong>
                </code>
                <CopyStatus />
              </button>
