...
import compareVideo from "../../asset/lander/exos-agent-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/exos-agent-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="exos-agent:auth" content={loggedin() ? "true" : "false"} />
