...
import { Database, eq, and, isNull } from "@exos-agent/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@exos-agent/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#exos-agent-go")} target="_blank" rel="noopener noreferrer">
