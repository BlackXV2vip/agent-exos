...
import { IconExosAgent } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "exos-agent/session/message-v2"
import type { Message } from "exos-agent/session/message"
import type { Session } from "exos-agent/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.exos-agent_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.exos-agent_name}>
                    <IconExosAgent width={16} height={16} />
                  </div>
