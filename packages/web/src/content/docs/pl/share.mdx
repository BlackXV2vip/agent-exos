---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące exos-agent.
---

Funkcja udostępniania exos-agent umożliwia tworzenie publicznych linków do konwersacji exos-agent, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, exos-agent:
...
exos-agent obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie exos-agent korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `exos-agent.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu exos-agent w Twojej organizacji.
