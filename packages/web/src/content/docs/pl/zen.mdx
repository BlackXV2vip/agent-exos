---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Exos Agent.
---
...
Exos Agent Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Exos Agent.

Zen działa jak każdy inny dostawca w Exos Agent. Logujesz się do Exos Agent Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Exos Agent.
:::
...
Exos Agent Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Exos Agent Zen działa jak każdy inny dostawca w Exos Agent.

1. Logujesz się do **<a href={console}>Exos Agent Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Exos Agent Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Exos Agent używa formatu
`exos-agent/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`exos-agent/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Exos Agent używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w Exos Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Exos Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Exos Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Exos Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Exos Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy Exos Agent Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Exos Agent także dowolnego innego dostawcy.
