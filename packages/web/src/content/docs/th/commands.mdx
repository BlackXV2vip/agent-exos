...
สร้าง `.exos-agent/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Exos Agent:
...
- ระดับผู้ใช้ (Global): `~/.config/exos-agent/commands/`
- ระดับโปรเจ็กต์: `.exos-agent/commands/`
...
Exos Agent มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
