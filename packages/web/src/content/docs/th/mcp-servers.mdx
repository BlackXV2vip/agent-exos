...
คุณสามารถเพิ่มเครื่องมือภายนอกให้กับ Exos Agent ได้โดยใช้ _Model Context Protocol_ หรือ MCP Exos Agent รองรับทั้งเซิร์ฟเวอร์ภายในและเซิร์ฟเวอร์ระยะไกล
...
คุณสามารถกำหนดเซิร์ฟเวอร์ MCP ได้ใน [Exos Agent Config](https://exos-agent.ai/docs/config/) ภายใต้ `mcp` เพิ่ม MCP แต่ละรายการด้วยชื่อที่ไม่ซ้ำใคร คุณสามารถอ้างอิงถึง MCP ด้วยชื่อได้เมื่อแจ้ง LLM
...
องค์กรสามารถจัดเตรียมเซิร์ฟเวอร์ MCP เริ่มต้นผ่านทางจุดสิ้นสุด `.well-known/exos-agent` เซิร์ฟเวอร์เหล่านี้อาจถูกปิดใช้งานตามค่าเริ่มต้น ทำให้ผู้ใช้สามารถเลือกใช้เซิร์ฟเวอร์ที่ต้องการได้
...
Exos Agent จะจัดการการตรวจสอบสิทธิ์ OAuth สำหรับเซิร์ฟเวอร์ MCP ระยะไกลโดยอัตโนมัติ เมื่อเซิร์ฟเวอร์ต้องการการรับรองความถูกต้อง Exos Agent จะ:
...
หากเซิร์ฟเวอร์ต้องมีการตรวจสอบสิทธิ์ Exos Agent จะแจ้งให้คุณตรวจสอบความถูกต้องเมื่อคุณพยายามใช้งานครั้งแรก หากไม่เป็นเช่นนั้น คุณสามารถ[ทริกเกอร์โฟลว์ด้วยตนเอง](#การตรวจสอบสิทธิ์) ด้วย `exos-agent mcp auth <server-name>`
...
คำสั่ง `mcp auth` จะเปิดเบราว์เซอร์ของคุณเพื่อขออนุญาต หลังจากที่คุณอนุญาตแล้ว Exos Agent จะจัดเก็บโทเค็นอย่างปลอดภัยใน `~/.local/share/exos-agent/mcp-auth.json`
...
MCP ของคุณพร้อมใช้งานในฐานะเครื่องมือใน Exos Agent ควบคู่ไปกับเครื่องมือในตัว คุณจึงสามารถจัดการผ่านการกำหนดค่า Exos Agent ได้เหมือนกับเครื่องมืออื่นๆ
...
ซึ่งจะเป็นการเปิดหน้าต่างเบราว์เซอร์เพื่อดำเนินการโฟลว์ OAuth ให้เสร็จสมบูรณ์ และเชื่อมต่อ Exos Agent กับบัญชี Sentry ของคุณ
