...
exos-agent имеет список сочетаний клавиш, которые вы можете настроить через `tui.json`.
...
exos-agent использует клавишу `leader` для большинства сочетаний клавиш. Это позволяет избежать конфликтов в вашем терминале.
...
Ввод приглашения настольного приложения exos-agent поддерживает распространенные сочетания клавиш в стиле Readline/Emacs для редактирования текста. Они встроены и в настоящее время не настраиваются через `exos-agent.json`.
