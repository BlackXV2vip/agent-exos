...
description: Crea strumenti che l'LLM puo chiamare in exos-agent.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di exos-agent come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.exos-agent/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/exos-agent/tools/`.
