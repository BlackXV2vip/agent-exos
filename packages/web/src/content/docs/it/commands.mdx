...
Crea `.exos-agent/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Exos Agent o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Exos Agent:
...
- Globale: `~/.config/exos-agent/commands/`
- Per progetto: `.exos-agent/commands/`
...
exos-agent include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
