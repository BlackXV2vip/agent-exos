---
title: Condivisione
description: Condividi le tue conversazioni Exos Agent.
---

La funzione di condivisione di Exos Agent ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Exos Agent:
...
Exos Agent supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Exos Agent usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `exos-agent.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare exos-agent nella tua organizzazione.
