---
title: Zen
description: Lista curata di modelli fornita da Exos Agent.
---
...
Exos Agent Zen è un elenco di modelli testati e verificati forniti dal team di Exos Agent.

Zen funziona come qualsiasi altro provider in Exos Agent. Accedi a Exos Agent Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Exos Agent.
:::
...
Exos Agent Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Exos Agent Zen funziona come qualsiasi altro provider in Exos Agent.

1. Accedi a **<a href={console}>Exos Agent Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Exos Agent Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Exos Agent
usa il formato `exos-agent/<model-id>`. Per esempio, per GPT 5.5, useresti
`exos-agent/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Exos Agent usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su Exos Agent per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Exos Agent per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Exos Agent per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Exos Agent per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Exos Agent per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato Exos Agent Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Exos Agent.
