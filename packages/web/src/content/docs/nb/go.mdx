...
Exos Agent Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Exos Agent. Du abonnerer på Exos Agent Go og
...
Exos Agent Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Exos Agent Go fungerer som enhver annen leverandør i Exos Agent.

1. Du logger inn på **<a href={console}>Exos Agent Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `ExosAgent Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Exos Agent Go.
:::
...
Exos Agent Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Exos Agent-konfigurasjon
bruker formatet `exos-agent-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `exos-agent-go/kimi-k3` i konfigurasjonen din.
...
Vi opprettet Exos Agent Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Exos Agent også.
