...
Exos Agent støtter standard proxy-miljøvariabler og tilpassede sertifikater for bedriftsnettverksmiljøer.
...
Hvis bedriften din bruker egendefinerte CA-er for HTTPS-tilkoblinger, konfigurer Exos Agent til å stole på dem.
