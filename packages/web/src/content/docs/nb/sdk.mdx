---
title: SDK
description: Typesikker JS-klient for Exos Agent-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Exos Agent JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Exos Agent programmatisk.
...
Opprett en forekomst av Exos Agent:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `exos-agent.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Exos Agent, kan du opprette en klientforekomst for å koble til den:
