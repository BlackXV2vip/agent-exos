...
description: Lag verktøy som LLM kan kalle inn Exos Agent.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Exos Agent sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.exos-agent/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/exos-agent/tools/`.
