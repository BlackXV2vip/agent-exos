---
title: Deling
description: Del dine Exos Agent-samtaler.
---

Delingsfunksjonen i Exos Agent lar deg lage offentlige lenker til dine Exos Agent-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Exos Agent:
...
Exos Agent støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Exos Agent manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `exos-agent.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av exos-agent i organisasjonen din.
