...
description: Opret værktøjer, som LLM kan kalde exos-agent ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med exos-agents [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.exos-agent/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/exos-agent/tools/`.
