...
Brug den til at bygge integrasjoner og kontrollere exos-agent programmatisk.
...
Opret en forekomst av exos-agent:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `exos-agent.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av exos-agent, kan du oprete en klientforekomst for at koble til den:
