...
Agentferdigheter lar Exos Agent oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Exos Agent opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Exos Agent viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `exos-agent.json`:
