---
title: LSP-servere
description: Exos Agent integreres med dine LSP-servere.
---

Exos Agent kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Exos Agent leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `EXOS_AGENT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og exos-agent åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din exos-agent-konfiguration.
