...
Kreiraj `.exos-agent/commands/test.md`:
...
Možete dodati prilagođene komande kroz Exos Agent konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Exos Agent [config](/docs/config):
...
- Globalno: `~/.config/exos-agent/commands/`
- Po projektu: `.exos-agent/commands/`
...
Exos Agent uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
