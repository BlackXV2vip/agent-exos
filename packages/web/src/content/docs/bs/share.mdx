---
title: Dijeljenje
description: Dijelite Exos Agent razgovore javnim linkovima.
---

Exos Agent opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Exos Agent:
...
Exos Agent podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Exos Agent koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `exos-agent.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju exos-agent u organizaciji.
