...
Exos Agent prend en charge les variables d'environnement proxy standard et les certificats personnalisés pour les environnements réseau d'entreprise.

---

## Proxy

Exos Agent respecte les variables d'environnement proxy standard.
...
Si votre entreprise utilise des autorités de certification personnalisées pour les connexions HTTPS, configurez Exos Agent pour leur faire confiance.
