...
Exos Agent supports standard proxy environment variables and custom certificates for enterprise network environments.
...
If your enterprise uses custom CAs for HTTPS connections, configure Exos Agent to trust them.
