...
يوفّر Exos Agent قائمة باختصارات لوحة المفاتيح يمكنك تخصيصها عبر إعدادات Exos Agent.
...
يستخدم Exos Agent مفتاح `leader` لمعظم اختصارات لوحة المفاتيح. يساعد ذلك على تجنّب التعارضات في terminal لديك.
...
يدعم حقل إدخال الموجّه في تطبيق Exos Agent لسطح المكتب اختصارات شائعة لتحرير النص على نمط Readline/Emacs. هذه الاختصارات مدمجة حاليا ولا يمكن تخصيصها عبر `exos-agent.json`.
