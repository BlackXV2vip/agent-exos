...
description: عميل JavaScript آمن الأنواع لخادم exos-agent.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ exos-agent لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في exos-agent برمجيا.
...
يمكنك تمرير كائن إعدادات لتخصيص السلوك. سيستمر المثيل في التقاط `exos-agent.json` لديك، لكن يمكنك تجاوز الإعدادات أو إضافة إعدادات مباشرة:
...
إذا كان لديك مثيل exos-agent يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
