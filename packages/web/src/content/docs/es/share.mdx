---
title: Compartir
description: Comparte tus conversaciones Exos Agent.
---

La función para compartir de Exos Agent te permite crear enlaces públicos a tus conversaciones de Exos Agent, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Exos Agent:
...
Exos Agent admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Exos Agent usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `exos-agent.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de exos-agent en su organización.
