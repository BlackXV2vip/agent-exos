...
Crear `.exos-agent/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Exos Agent o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Exos Agent [config](/docs/config):
...
- Por proyecto: `.exos-agent/commands/`
...
exos-agent incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
