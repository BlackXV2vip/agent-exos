---
title: Share
description: Share your Exos Agent conversations.
---

Exos Agent's share feature allows you to create public links to your Exos Agent conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Exos Agent:
...
Exos Agent supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Exos Agent uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `exos-agent.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using exos-agent in your organization.
