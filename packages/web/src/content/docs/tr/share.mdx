---
title: Paylasim
description: exos-agent konusmalarini genel baglantilarla paylasin.
---

exos-agent'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda exos-agent:
...
exos-agent, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak exos-agent manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `exos-agent.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda exos-agent kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
