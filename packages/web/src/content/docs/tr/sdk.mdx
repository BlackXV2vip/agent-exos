---
title: SDK
description: exos-agent sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

exos-agent JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
exos-agent'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir exos-agent örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `exos-agent.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir exos-agent örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
