---
title: Teilen
description: Teile Exos Agent-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Exos Agent-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Exos Agent Folgendes:
...
Exos Agent hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Exos Agent den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`exos-agent.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du exos-agent in deiner Organisation einsetzt.
