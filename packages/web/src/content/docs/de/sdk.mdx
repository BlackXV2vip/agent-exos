---
title: SDK
description: Typsicherer JS-Client fuer den exos-agent-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das exos-agent JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und exos-agent programmatisch steuern.
...
Erstelle eine exos-agent-Instanz:
...
`exos-agent.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn exos-agent bereits laeuft, kannst du nur einen Client erstellen und verbinden:
