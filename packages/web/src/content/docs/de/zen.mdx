---
title: Zen
description: Kuratierte Modellliste direkt von Exos Agent.
---
...
Exos Agent Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Exos Agent-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Exos Agent. Du meldest dich bei Exos Agent Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Exos Agent zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Exos Agent funktionieren.
:::
...
Exos Agent Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Exos Agent Zen funktioniert wie jeder andere Provider in Exos Agent.

1. Du meldest dich bei **<a href={console}>Exos Agent Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Exos Agent Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Exos Agent-Konfiguration verwendet das Format `exos-agent/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `exos-agent/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Exos Agent verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Exos Agent verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Exos Agent verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Exos Agent verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Exos Agent verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Exos Agent verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Exos Agent Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Exos Agent auch jeden anderen Provider zu verwenden.
