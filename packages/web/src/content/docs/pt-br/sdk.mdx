---
title: SDK
description: Cliente JS seguro em tipos para o servidor exos-agent.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do exos-agent fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o exos-agent programaticamente.
...
Crie uma instância do exos-agent:
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `exos-agent.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do exos-agent em execução, pode criar uma instância de cliente para se conectar a ela:
