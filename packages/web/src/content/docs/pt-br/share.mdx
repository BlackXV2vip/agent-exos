---
title: Compartilhar
description: Compartilhe suas conversas do exos-agent.
---

O recurso de compartilhamento do exos-agent permite que você crie links públicos para suas conversas do exos-agent, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o exos-agent:
...
O exos-agent suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o exos-agent usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `exos-agent.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o exos-agent em sua organização.
