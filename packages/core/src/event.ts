...
import type { Data, Definition, Payload } from "@exos-agent/schema/event"
...
import { Durable } from "@exos-agent/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@exos-agent/schema/event").ID
export type { Data, Definition, Payload } from "@exos-agent/schema/event"
