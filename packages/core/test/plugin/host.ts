import type { PluginContext } from "@exos-agent/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@exos-agent/sdk/v2/types"
