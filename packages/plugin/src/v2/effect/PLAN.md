...
- Effect plugins import `@exos-agent/plugin/v2/effect`, not `@exos-agent/core`.
- Public domain values use generated `@exos-agent/sdk` types.
...
- Define `PluginHost` domain capabilities in `@exos-agent/plugin/v2/effect`.
