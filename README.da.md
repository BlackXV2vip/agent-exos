...
brew install BlackXV2vip/tap/exos-agent # macOS og Linux (anbefalet, altid up to date)
...
Exos Agent findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/BlackXV2vip/agent-exos/releases) eller [exos-agent.ai/download](https://exos-agent.ai/download).
